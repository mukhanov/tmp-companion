...
pub(crate) const FIXTURE_SOURCE_STAMP: &str = "tmp-companion-e2e-fixture#r4";
...
mod tests {
    ...
    fn pristine_check_flags_leveled_bodies() {
        let fixture = r#"{"audioGraph":{"nodes":[],"presetLevel":0.5999999046325684},"info":{"source_id":"tmp-companion-e2e-fixture#r4"}}"#;
        let same = fixture.as_bytes();
        let leveled = r#"{"audioGraph":{"nodes":[],"presetLevel":0.37495},"info":{"source_id":"tmp-companion-e2e-fixture#r4"}}"#.as_bytes();
    ...
    fn pristine_check_flags_a_structural_block_delete() {
        let fixture = r#"{"info":{"source_id":"tmp-companion-e2e-fixture#r4"},"audioGraph":{"presetLevel":0.32,"guitarNodes":{"G1":[{"FenderId":"ACD_TubeScreamer","nodeId":"ACD_TubeScreamer"},{"FenderId":"ACD_FiveBandParamEQ","nodeId":"ACD_FiveBandParamEQ"}]}}}"#;
        ...
        let mutilated = r#"{"info":{"source_id":"tmp-companion-e2e-fixture#r4"},"audioGraph":{"presetLevel":0.32,"guitarNodes":{"G1":[{"FenderId":"ACD_TubeScreamer","nodeId":"ACD_TubeScreamer"}]}}}"#;
        assert!(
        ...
        let level_drifted = r#"{"info":{"source_id":"tmp-companion-e2e-fixture#r4"},"audioGraph":{"presetLevel":0.5,"guitarNodes":{"G1":[{"FenderId":"ACD_TubeScreamer","nodeId":"ACD_TubeScreamer"},{"FenderId":"ACD_FiveBandParamEQ","nodeId":"ACD_FiveBandParamEQ"}]}}}"#;
        assert_eq!(
